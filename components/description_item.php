...
function renderProductCard($props) {
  ...
  <div class="bg-white rounded-2xl shadow-lg overflow-hidden relative flex flex-col md:flex-row">
      <!-- Left: Image Slider with fixed height and dark background -->
      <div class="slider-container relative w-full md:w-1/2 h-96 bg-black bg-opacity-40"> <!-- Fixed height and darkened background -->
          <div class="slider">
      ...
      <!-- Right: Product Details with flexible height -->
      <div class="p-6 flex flex-col justify-between w-full md:w-1/2">
          ...
          <div class="mt-6 flex items-center justify-between">
              <button class="w-2/4 bg-[#B82132] text-white py-3 px-6 rounded-lg font-semibold 
                           hover:bg-[#801723] transition duration-300">
                  Add to Cart
              </button>

              <div class="flex items-center space-x-2 ml-4">
                  <span class="text-lg font-semibold text-gray-800">Quantity:</span>
                  <button class="decrease-btn bg-gray-200 text-gray-600 px-2 py-1 rounded-md hover:bg-gray-300 transition">
                      -
                  </button>
                  <span id="quantity" class="text-lg font-semibold">1</span>
                  <button class="increase-btn bg-gray-200 text-gray-600 px-2 py-1 rounded-md hover:bg-gray-300 transition">
                      +
                  </button>
              </div>
          </div>
  ...
  <script>
      ...
      // Show the slide at the correct index
  ...
  <style>
      /* Ensure the slider maintains the same height */
      .slider-container {
          position: relative;
          height: 100%; /* Ensure the container is the full height of the image */
      }
      ...
      .prev-btn, .next-btn {
          ...
          font-size: 2.5rem; /* Make arrows larger */
          background: rgba(67, 66, 66, 0.5); /* Removed black shading */
          color: white;
          border: none;
          padding: 10px;
          cursor: pointer;
      ...
      .slider-image {
          ...
          width: 100%;
          height: 100%;
          object-fit: cover; /* Keep the images the same height */
      }
      ...
      /* Size Options Container Styles */
      .size-container {
          display: flex;
          gap: 1rem; /* Space between size buttons */
      }
